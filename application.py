...
buttons_field = html.Div(
    ...
    children=[
        ...
        html.Div(className='buttons control', children=[
            button_primary,
            button_loading,
            button_warning,
        ]),
        dcc.Markdown('You can see more info on different button styles and classes [here](http://www.somewhere.com)', className='help')
    ]
)
...
checkboxes_field = html.Div(
    className='field',
    children=[
        html.Label('Checklist', className='label'),
        checkboxes
    ]
)
...
radios_field = html.Div(
    className='field',
    children=[
        html.Label('RadioItems', className='label'),
        radios
    ]
)
...
form_elements_section = html.Div(
    ...
    children=[
        ...
        html.H4('These examples can be copy/pasted where appropriate.', className='subtitle is-4'),
        html.Div(
            className='columns',
            children=[
                html.Div(
            ...
            html.Div(className='navbar-end', children=[
                html.Div(className='navbar-item', children=[
                    html.Div(className='buttons', children=[
                        html.A('Sign up', className='button is-primary'),
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.H3(
                            'General Subheader (h3)',
                            className='subtitle is-3',
                        ),
                        html.H4(
                            'General Subheader (h4)',
                            className='subtitle is-4',
                        ),
                        html.H5(
                            'General Subheader (h5)',
                            className='subtitle is-5'
                        )
                    ]
                ),
